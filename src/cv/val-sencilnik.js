/**
 * Val, ki odpre sliko - sencilnika in mere.
 *
 ...
 *
 * Tu stojita zato, ker ju uporabljata dva: ogled cez celo stran (plapol.js) in
 * val na mestu slike v besedilu (val.js). Ista snov, dve legi.
 */

/** Koliko prostora okoli slike pusti platno, da se gube ob robu ne odrezejo. */
export const ZRAK = 1.18;
